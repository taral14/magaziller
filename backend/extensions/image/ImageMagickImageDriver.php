 ...
 */
class ImageMagickImageDriver extends Image {
	...
	public static function check()
	{
		...
		return ImageMagickImageDriver::$_checked = TRUE;
	}

	/**
	 * Runs [ImageMagickImageDriver::check] and loads the image.
	 *
	 * @return  void
	 * @throws  CException
	 */
	...
	{
		if ( ! ImageMagickImageDriver::$_checked)
		{
			// Run the install check
			ImageMagickImageDriver::check();
		}
