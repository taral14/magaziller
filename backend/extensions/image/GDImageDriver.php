 ...
 */
class GDImageDriver extends Image {
	...
	public static function check()
	{
		...
		if (defined('GD_BUNDLED'))
		{
			...
			GDImageDriver::$_bundled = GD_BUNDLED;
		}
		else
		{
			...
			GDImageDriver::$_bundled = (bool) preg_match('/\bbundled\b/i', $info['GD Version']);
		}
		...
		{
			throw new CException('GDImageDriver requires GD version 2.0.1 or greater, you have '.$version);
		}

		return GDImageDriver::$_checked = TRUE;
	}
	...
	/**
	 * Runs [GDImageDriver::check] and loads the image.
	 *
	 * @return  void
	 * @throws  CException
	 */
