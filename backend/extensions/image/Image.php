...
abstract class Image {
	...
	public static function factory($file, $driver = NULL)
	{
		...
		// Set the class name
        $class = $driver.'ImageDriver';
        Yii::import("application.extensions.image.$class");
	...
	public function __construct($file)
	{
		...
		{
			throw new CException('Not an image or invalid image');
		}
	...
	public function save($file = NULL, $quality = 100)
	{
		...
		if (is_file($file))
		{
			if ( ! is_writable($file))
			{
				throw new CException('File must be writable');
			}
		}
		else
		{
			...
			{
				throw new CException('Directory must be writable');
			}
		}
