...
class DeliveryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Delivery']))
		{
			...
			if($model->save()) {
                Yii::app()->user->setFlash('success', "Доставка добавлена");
                $this->redirect(array('update','id'=>$model->id));
            } else {
                Yii::app()->user->setFlash('error', "Доставка не добавлена");
            }
		}
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
            ...
            $model=$this->loadModel($id);
            Yii::app()->user->setFlash('success', "Доставка &quot;{$model->name}&quot; удалена");
			$model->delete();
	...
	{
		$model=Delivery::model()->findByPk((int)$id);
		if($model===null)
