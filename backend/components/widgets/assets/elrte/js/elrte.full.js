...
elRTE.prototype.options   = {
	...
	panels      : {
		...
		save       : ['save'],
		copypaste  : ['pastetext', 'pasteformattext'],
		undoredo   : ['undo', 'redo'],
		...
		images     : ['image'],
		media      : ['elfinder', 'image', 'flash'],
		tables     : ['table', 'tableprops', 'tablerm', 'tbcellprops', 'tbcellsmerge', 'tbcellsplit'],
		elfinder   : ['elfinder'],
		fullscreen : ['fullscreen', 'about']
	},
	toolbars    : {
		tiny     : ['style'],
		compact  : ['undoredo', 'style', 'alignment', 'lists', 'links'],
        normal   : ['undoredo', 'copypaste', 'media', 'style', 'alignment', 'colors', 'indent', 'lists', 'eol', 'links', 'format', 'tables'],
        complete : ['copypaste', 'undoredo', 'style', 'alignment', 'colors', 'format', 'indent', 'lists', 'links', 'elements', 'media'],
        maxi     : ['copypaste', 'undoredo', 'elfinder', 'style', 'alignment', 'direction', 'colors', 'format', 'indent', 'lists', 'links', 'elements', 'media', 'tables'],
        eldorado : ['copypaste', 'elfinder', 'undoredo', 'style', 'alignment', 'colors', 'format', 'indent', 'lists', 'links', 'elements', 'media', 'tables']
