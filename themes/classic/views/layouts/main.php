            ...
            <div class="header_l">
                ...
                <div class="search">
                    ...
                    <div class="search_bg">
                        ...
                        <?php echo CHtml::beginForm('search/result', 'get'); ?>

                        <?php echo CHtml::dropDownList('category_id', @$_GET['category_id'], CHtml::listData(Category::model()->rooted()->findAll(),'id','name'))?>
                        <div class="search_separator"></div>
                        <?php echo CHtml::textField('query',@$_GET['query'],array('class'=>'search_text','placeholder'=>'Пошук...')); ?>
